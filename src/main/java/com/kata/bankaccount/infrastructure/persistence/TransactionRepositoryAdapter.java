...
public class TransactionRepositoryAdapter implements TransactionRepository {
    ...
    private Transaction toDomain(TransactionEntity entity) {
        ...
        return new Transaction(
                com.kata.bankaccount.domain.model.TransactionId.of(entity.getId()),
                entity.getType(),
                com.kata.bankaccount.domain.model.Money.of(entity.getAmount(), currency),
                com.kata.bankaccount.domain.model.Money.of(entity.getBalanceAfter(), currency),
